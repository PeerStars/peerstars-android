...
public class PSTCustomMemberAdapter extends BaseAdapter implements Filterable {
    ...
    public PSTCustomMemberAdapter(Context context, PSTDatabaseTableGroups tableGroups) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_member_list_item, parent, false);
        }
        ((TextView) convertView.findViewById(R.id.txtName)).setText(getItem(position).getName());
        ((TextView) convertView.findViewById(R.id.txtClassYear)).setText(getItem(position).getStreet());
        //((PSTCustomImageView) convertView.findViewById(R.id.imgMember)).setImageBitmap(getItem(position).getAddress());
        return convertView;
    }
