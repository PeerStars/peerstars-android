...
import com.peerstars.android.BuildConfig;
...
/**
 * Created by bmiller on 9/21/2015.
 */
public class PSTContentCache {

    private static DiskLruCache mDiskCache;
    private static LruCache<String, Bitmap> mMemoryCache = null;
    private static boolean bIsInitialized = false;
    private static boolean bIsDiskInitialized = false;
    ...
    public static boolean initializeCache(int maxsize) {
        try {
    ...
    public static boolean initializeDiskCache(Context context, String uniqueName, int diskCacheSize,
                                              Bitmap.CompressFormat compressFormat, int quality) {
        try {
            final File diskCacheDir = Util.getExternalCacheDir(context);
    ...
    public static boolean isDiskInitialized() {
        return bIsDiskInitialized;
    }
